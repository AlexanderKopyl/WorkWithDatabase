...
$ru = array(
    ...
    'Develop a function to sample, add, remove from database data' => 'Разработайте функцию для выборки, добавления, удаления из данных базы данных'
);
$en = array(
    'site.title' => "My site",
    'author.name' => "John Doe",
    'Develop a function to sample, add, remove from database data' => 'Develop a function to sample, add, remove from database data'
);
$uk = array(
    'site.title' => "Наш сайт",
    'author.name' => "Василь пупкин",
    'Develop a function to sample, add, remove from database data' => 'Розробити функціонал для вибірки, додавання, видалення з БД даних'
);
...
// $LANG = $_GET['lang'] === 'ru' ? $ru : $uk ? $en;
echo $_GET['lang'];
 ?>
	<p><?=$LANG['author.name']?></p>
	<!--  -->
	<div>
		<a href='http://array/?lang=ru' data-leng='ru'>ru</a>
		<a href='http://array/?lang=en' data-leng='en'>en</a>
		<a href='http://array/?lang=uk' data-leng='uk'>UK</a>
			</div>
<h1>
				ЗАДАНИЕ: Мультиязычьность РУ
			</h1>
					<ul class=''>
				<li><p>1.<?=$LANG['Develop a function to sample, add, remove from database data']?></p></li>
